...
class Localization {
  ...
  static void load(
    ...
    instance._stringProcessor = stringProcessor ?? (value, key, arg) => value.replaceAll(key, arg);
    instance._pluralProcessor = pluralProcessor ?? (value, key, arg) => value.replaceAll(key, arg);
  }
  ...
  String plural(String key, num value, {Map<String, dynamic>? args}) {
    Map<String, String> forms = _getAllPluralForms(key, _translations);
  ...
  String? _putArgs(String? template, num value, {Map<String, dynamic>? args}) {
    ...
    return args == null ? template : _assignArguments(template, args);
  }
  ...
  Map<String, String> _getAllPluralForms(String key, Map<String, dynamic> map) {
    ...
    return {for (String k in map[key].keys) k: map[key][k].toString()};
  }
}
